...
from src.components.model_trainer import Modeltrain,Modeltrainconfig
...
if __name__=="__main__":
    ...
    train_arr,test_arr,_=data_transform.initiate_transformation(train_data,test_data)
    model_train=Modeltrain()
    
    print(model_train.initiate_model_train(X_train=train_arr[:,:-1],y_train=train_arr[:,-1],X_test=test_arr[:,:-1],y_test=test_arr[:,-1]))
